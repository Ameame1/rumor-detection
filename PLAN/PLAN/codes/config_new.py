...
curr_dir = os.getcwd()
last_dir = os.path.basename(curr_dir)
last_dir = curr_dir.replace(last_dir, '')
last_dir = last_dir + 'logs/'
...
class Config():
    ...
    def __init__(self):
        ...
        self.data_set = "weibo_dataset"
        self.data_folder = "/home/ame/rumor/PLAN/codes/data/weibo"
        self.train_file_path = "weibo_train_repair.json"
        self.test_1_file_path = "weibo_test1_repair.json"
        self.test_2_file_path = "weibo_test2_repair.json"
        ...
        # Logs paths
        self.dataset_name = "test_weibo"
        self.experiment_name = "HiT_0"
        self.log_folder = last_dir
